...
function move1(){
  ...
  if(event.keyCode === 70 && forword > 0 ) { // f
   ...
   if(event.keyCode === 71 ) {  //g 
    character.style.width = "462px"
    character.style.height = "462px"
     character.src = "./img/fi5.gif"
     setTimeout(function(){
      character.src = "./img/fightr1.gif"
...
console.log(event.keyCode)
 ...
 if(event.keyCode == 37 && forword2 < 1120){ // <-
 ...
 if(event.keyCode === 39 && forword2  > 0 ) { // ->
  forword2 = forword2 - 20
   character2.style.right = forword2 + "px"
   ...
   if(event.keyCode === 8) { //backspace 
    ...
    setTimeout(function(){
      character2.src = "./img/fightr2.gif"
    },1500)
   }    

   if(event.keyCode === 88 ) { //x
     character2.src = "./img/fig3.gif"
